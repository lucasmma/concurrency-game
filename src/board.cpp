...
// bool Board::isSpotAvailableOnBoard(std::vector<int> spot, int playerNumber){
...
// std::vector<int> Board::checkNeighboarsPlayersOnBoard(int x, int y){
...
// void Board::updateBoard(std::vector<int> spot, int playerNumber){
